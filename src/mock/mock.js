...
},
{
  ...
  "price": "R$200,00",
  "colors": ["Não tem cores"],
  "description":"Conheça uma das séries de jogos mais veneradas de todos os tempos ao acompanhar a arriscada jornada de Nathan Drake pelo mundo, de um começo humilde a descobertas extraordinárias."
...
},
{
  ...
  "price": "R$200,00",
  "colors": ["Não tem cores"],
  "description":"Seja você um piloto competitivo ou casual, colecionador, tuner, designer de visuais ou fotógrafo — encontre seu caminho com um número impressionante de modos de jogo, incluindo favoritos dos fãs como Campanha GT, Arcade e Escola de Pilotagem."
